...
class WriteStepPromptTest {
    ...
    private static Outline outline(String style1, String style2) {
        return new Outline("tpl", "2026-W26", List.of(
                new Outline.OutlineChapter("c1", "一、概览", List.of("m1"), null, "指引一", style1),
                new Outline.OutlineChapter("c2", "二、收支", List.of("m2"), "week_over_week", "指引二", style2)),
                List.of());
    }
    ...
    void factsStillGroupedPerChapter() {
        FactRecord f1 = new FactRecord("fact_001", "m1", "指标一", "c1", "BASE",
